...
# Make new centroids by getting the distance between the old and new centroids
# Plot the centroids
# Print out the countries and means for each cluster
...
user_input = input("What file would you like to cluster: ")
countries, dataSet, birthRate, lifeExp = readCsv(user_input)
...
#Requests how many clusters the user would like
